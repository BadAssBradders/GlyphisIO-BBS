# Quick Start Guide - Icosahedron Game Project
...
1. Open **Notepad++**
2. **File** → **Open**
3. Navigate to: `C:\Dev Projects\Icosahedron\src\main.cpp`
4. You'll see the example game code

### Step 4: Build Your Project
1. Open **File Explorer**
2. Navigate to: `C:\Dev Projects\Icosahedron`
...
### Step 5: Run the Game
**Option A - Manual:**
1. Navigate to: `C:\Dev Projects\Icosahedron\bin\x64\Debug\`
2. Double-click `Icosahedron.exe`
...
└── bin/
    └── x64/
        └── Debug/
            └── Icosahedron.exe  ← Your compiled game
```
...
- Make sure `raylib.dll` is in the same folder as `Icosahedron.exe`
