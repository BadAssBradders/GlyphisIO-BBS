# Setting Up MinGW/GCC for Torus Project
...
```cmd
g++ -std=c++17 -O2 -I C:/raylib/include src/main.cpp -L C:/raylib/lib -lraylib -lwinmm -lgdi32 -o bin/Torus.exe
