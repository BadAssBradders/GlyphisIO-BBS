...
1. Open `Torus.sln` in Visual Studio
...
├── Torus.sln         # Visual Studio solution file
├── Torus.vcxproj     # Visual Studio project file
└── README.md         # This file
```
...
3. **Run the game**:
   - After building, run: `bin\x64\Debug\Torus.exe` (or Release version)
