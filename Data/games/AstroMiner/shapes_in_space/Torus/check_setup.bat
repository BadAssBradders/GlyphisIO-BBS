@echo off
echo ========================================
echo Torus Project Setup Diagnostic
echo ========================================
echo.
...
if exist "Torus.sln" (
    echo    [OK] Found Torus.sln
) else (
    echo    [X] Torus.sln NOT found
)

if exist "Torus.vcxproj" (
    echo    [OK] Found Torus.vcxproj
) else (
    echo    [X] Torus.vcxproj NOT found
)
