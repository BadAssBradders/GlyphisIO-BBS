@echo off
REM Build script for Torus Raylib project
REM Edit your code in Notepad++, then run this script to build

echo Building Torus project...
echo.
...
echo.
"%MSBUILD_PATH%" Torus.sln /p:Configuration=Debug /p:Platform=x64 /m /v:minimal
...
if %BUILD_RESULT% EQU 0 (
    ...
    echo.
    echo Executable location: bin\x64\Debug\Torus.exe
    echo.
    echo To run the game, execute: bin\x64\Debug\Torus.exe
) else (
    echo.
    echo ========================================
